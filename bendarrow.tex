...
\usepackage{tikz}
\usetikzlibrary{shapes.multipart,shapes.arrows,decorations.markings}
\usepackage[margin=1in]{geometry}
\begin{document}

\tikzset{shape example/.style={color=black!30,draw,fill=yellow!30,line width=0.5cm,inner xsep=2.5cm,inner ysep=0.5cm}}
...
\pgfdeclareshape{single bent arrow}{%
	...
	\backgroundpath{%
		{%
			...
			\pgfpathlineto{\beforearrowbend\pgf@y-\pgf@y}%
...
\Huge
\begin{tikzpicture}
  \node[name=s,single bent arrow,draw,shape example,single bent arrow head extend=1.5cm] {Single Bent Arrow\vrule width1pt height2cm};
  \foreach \anchor/\placement in
    ...
    after head/below, after tail/below, before tail/below, tail/right,
    after bend/below, before bend/above,
